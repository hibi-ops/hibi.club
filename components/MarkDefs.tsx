...
export default function MarkDefs() {
  return (
    <svg aria-hidden="true" style={{ position: "absolute", width: 0, height: 0 }}>
      <defs>
        <mask id="hibi-cut" maskUnits="userSpaceOnUse" x="0" y="0" width="200" height="200">
          <rect width="200" height="200" fill="#fff" />
          <g fill="#000" stroke="#000" strokeWidth="12" strokeLinejoin="round" strokeLinecap="round">
        ...
        <symbol id="hibi-mk" viewBox="0 0 200 200">
          <circle cx="100" cy="100" r="92" fill="var(--mc,#15141a)" mask="url(#hibi-cut)" />
        </symbol>
      </defs>
    </svg>
  );
